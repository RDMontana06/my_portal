    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class='col-md-10'>
                    <h5 class="modal-title" id="new_portal"><i class="fa-solid fa-file-plus"></i> New Portal </h5>
                </div>
                <div class='col-md-2'>
            ...
            <form method='post' action='new-portal' onsubmit="show()" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" oninput="this.value = this.value.toUpperCase()" class="form-control" id="title" placeholder="Enter title"
                            name="title_portal" required>
                    </div>
                    <div class="form-group">
