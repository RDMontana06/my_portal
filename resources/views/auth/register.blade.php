    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input value='{{old('birth_date')}}' type="date" name="birth_date"  class="form-control" max='<?php echo date('Y-m-d')?>' id="birth_date">
            </div>
        </div>
            <div class="col-sm-3">
            <div class="form-group">
                <label class="" for="birth_place">Birth Place</label>
                <input value='{{old('birth_place')}}' type="text" name="birth_place"  placeholder="City. ." class="form-control" id="birth_place">
            </div>
        </div>
    </div>
    <hr>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <textarea value='{{old('present_address')}}' name="present_address" placeholder="Present address..." class=" form-control" id="present_address"></textarea>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label class="sr-only" for="permanent_address">Permanent Address</label>
                <textarea value='{{old('permanent_address')}}' name="permanent_address" placeholder="Permanent address..." class=" form-control" id="permanent_address"></textarea>
            </div>
        </div>
    </div>
    <hr>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input value='{{old('personal_email')}}' type="email" name="personal_email" placeholder="Personal Email..." class="form-control" id="personal_email">
            </div>
        </div>
    </div>
    <div class="">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input value='{{old('company_email')}}' type="email" name="company_email" placeholder="Company Email..." class="form-control" id="company_email">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="company" id="company">
                        ...
                        @foreach($companies as $company)
                            ...
                            <option value="{{ $company->code}}"  @if( old('company') == $company->code) selected="selected" @endif>{{ $company->descs}}</option>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input value='{{old('position')}}' type="text" name="position" placeholder="Position..." class=" form-control" id="position">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input value='{{old('employee_code')}}' type="text" name="employee_code" placeholder="Employee Code. ." class="form-control" id="employee_code">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input value='{{old('date_hired')}}' type="date" name="date_hired" class="date_hired" id="date_hired">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <label class="" for="date_regularized">Date Regularized</label>
                    <input value='{{old('date_regularized')}}' type="date" name="date_regularized"  class=" form-control" id="date_regularized">
                </div>
            </div>
        </div>
